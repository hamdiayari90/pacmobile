...
const InscriptionSup3 = () => {
  ...
  const {
    ...
    onSubmit: async (values) => {
        ...
        address: route.params.sup.address,
        dateOfBirth: route.params.sup.dateOfBirth,
        regions: route.params.sup.regions,
        etatCivil: route.params.sup.etatCivil,
        sexe: route.params.sup.sexe,
        cin: route.params.sup.cin,
        taille: values.taille,
        poids: values.poids,
        permis: permis,
        vehicule: voiture,
        };
        let image =route.params.sup.image;
        let verifyUserName = axios.get(
          ...
          Promise.all([verifyUserName, verifyEmail, verifyCin]).then(async (result) => {
            ...
            if (
              ...
              await fetch(`${url}/supervisor/addSupervisor`, requestaddAnimator)
                .then((data) => data.text())
                .then(async (animator) => {
                  ...
                  await AsyncStorage.setItem(
                    ...
                    let endPoint =  url +'/supervisor/addImageToSupervisor/'+ animator;
                  ...
                  axios
                    ...
                    .then(async (autoLogin) => {
                      ...
                      try {
                        ...
                        console.log('fcm super visor divece  ===> :', fcm)
  ...
  return (
    <View style={styles.inscriptionsup3}>
      ...
      <View style={[styles.formControl2, styles.formLayoutV]}>
        <Text style={[styles.placeholderV, styles.placeholderTypo]}>Avez-vous un permis de conduite</Text>
              <View
                style={{
                  flexDirection: "row",
              ...
              >
                ...
                >
                  <RadioButton
                    ...
                    color={Color.primary}
                  />
                  <Text style={{color: Color.darkDark2,fontSize: FontSize.mainBodyRegular_size}}>non</Text>
                </View>
                <View
                  style={{
                    alignItems: "center",
                ...
                >
                  <RadioButton
                    ...
                    color={Color.primary}
                  />
                  <Text style={{color: Color.darkDark2,fontSize: FontSize.mainBodyRegular_size}}>oui</Text>
                </View>
              </View>
      </View>
      <View style={[styles.formControl3, styles.formLayoutV]}>
      <Text style={[styles.placeholderV, styles.placeholderTypo]}>Avez-vous véhicule</Text>
              <View
                style={{
                  flexDirection: "row",
                  justifyContent: "space-evenly",
...
export default InscriptionSup3;
